...
import styles from "./AllBudgetInsights.module.css";
...
const LimitStatusPill = ({ balance }) => {
  ...
  return (
    <div className={isLimitExceeded ? styles["limit-exceed-btn"] : styles["limit-within-btn"]}>
      {LimitStatusText}
    </div>
  );
};
...
const AllBudgetInsights = () => {
  ...
  return (
    <div className={styles.insights}>
      <table className={styles["insight-table"]}>
        <thead>
          <tr>
