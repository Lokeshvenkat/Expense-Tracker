...
import styles from "./TransactionFilters.module.css"; // Import CSS module
...
const TransactionFilters = () => {
  ...
  const getPillClass = (filterName) =>
    `${styles["single-pill"]} ${activeFilter === filterName ? styles["single-pill-active"] : ""}`;
  ...
  return (
    <div className={styles["transaction-filter"]}>
      ...
      <div className={styles["filter-pills"]} id="filter" onClick={handleFilterClick}>
        {/* All filter pill */}
